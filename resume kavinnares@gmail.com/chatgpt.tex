...
\usepackage{multicol}
\usepackage{xcolor} % Remove duplicate package

\usepackage{ulem} % Remove duplicate package
...
% Custom command to underline and color hyperlinks
\newcommand{\customhref}[2]{\href{#1}{\textcolor{cyan}{\uline{#2}}}}
...
\small{\item{
    ...
    \resumeSubheading
      \customhref{\href{https://www.linkedin.com/posts/shakthivarman-thangavelu_happy-to-announce-that-i-have-lead-this-young-activity-7132986612459655168-5suN?utm_source=share&utm_medium=member_desktop}}{IBM WatsonX Challenge for GSI}{Bengaluru, Karnataka}
      {IBM - Watsonx Assistant, Watsonx.ai, and Watson Discovery}{Nov 2023 -- Dec 2023, Infosys Techzooka (Team: 6)}
        \resumeItemListStart
